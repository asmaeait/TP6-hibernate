...
public class ConcurrentReservationSimulator {
    ...
    private static void initData() {
        Utilisateur utilisateur1 = new Utilisateur("Dupont", "Jean",
                "jean.dupont@example.com");
        Utilisateur utilisateur2 = new Utilisateur("Martin", "Sophie",
    ...
    private static void simulateConcurrentReservationConflict()
        ...
        Thread thread1 = new Thread(() -> {
            try {
                ...
                System.out.println("Thread 1 : Réservation récupérée, version = "
                        + r1.getVersion());
        ...
        Thread thread2 = new Thread(() -> {
            try {
                ...
                System.out.println("Thread 2 : Réservation récupérée, version = "
                        + r2.getVersion());
        ...
        reservationService.findById(1L).ifPresent(r -> {
